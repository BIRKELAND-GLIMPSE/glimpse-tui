...
KEYMAP: dict[str, list[tuple[str, list[tuple[str, str]]]]] = {
    ...
    "bots": [
        ...
        ("RUN", [("enter", "run / stop"), ("b", "bet its order once"), ("e", "budget"), ("x", "stop"), ("X", "stop all"),
                 ("L", "log in to trade real sats")]),
        ("MORE", [("m", "forecast / trades"), ("- + 0", "zoom out / in / reset"), ("r", "re-read the market")]),
    ],
    "bots-forecast": [
        ("MOVE", [(VERT, "a close"), (SIDE, "a day"), ("gg G", "first / last close"), ("tab esc", "back to the bots")]),
        ("READ", [("i", "how this model works: idea, data, maths, trades"), ("m", "forecast / trades"),
                  ("- + 0", "zoom out / in / reset")]),
        ("RUN", [("enter", "run / stop this bot"), ("b", "bet this close's order once"), ("e", "budget"), ("x", "stop"),
                 ("L", "log in to trade real sats")]),
